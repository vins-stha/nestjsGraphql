...
export declare class ResolversExplorerService extends BaseExplorerService {
    ...
    createContextCallback<T extends Record<string, any>>(instance: T, prototype: any, wrapper: InstanceWrapper, moduleRef: Module, resolver: ResolverMetadata, isRequestScoped: boolean, transform?: Function): (...args: any[]) => Promise<any>;
